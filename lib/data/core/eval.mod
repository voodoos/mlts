...
copy (match X Y) (match U V) :- copy X U, mappred copyrulexxx Y V.
...
copyrulexxx (X ==> Y) (U ==> V) :- copy X U, copy Y V.

copyrulexxx (nab R) (nab S) :- pi x\ copy x x => copyrulexxx (R x) (S x).
copyrulexxx (all R) (all S) :- pi x\ copy x x => copyrulexxx (R x) (S x).

copyrulexxx (all'  R) (all'  S) :- pi x\ (pi X\ pi U\ copy (x X) (x U) :- copy X U) => copyrulexxx (R x) (S x).
copyrulexxx (all'' R) (all'' S) :- pi x\ (pi X\ pi Y\ pi U\ pi V\ copy (x X Y) (x U V) :- copy X U, copy Y V) => copyrulexxx (R x) (S x).
